...
@section('content')
    ...
    <div class="bg-gray-800/50 border border-gray-700 rounded-xl p-4 mb-6">
        <form method="GET" class="flex flex-wrap gap-4">
            ...
            <div>
                <select name="format" class="bg-gray-700 border border-gray-600 text-white rounded-lg px-4 py-2 focus:ring-green-500 focus:border-green-500">
    ...
    @if($tournaments->count() > 0)
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            @foreach($tournaments as $tournament)
                <a href="{{ route('tournaments.show', $tournament) }}" class="bg-gray-800/50 border border-gray-700 rounded-xl overflow-hidden hover:border-green-500/50 transition group">
