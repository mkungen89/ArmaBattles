...
@section('content')
    ...
    <div class="flex flex-wrap items-center justify-center gap-3 mb-16">
        <a href="#general" class="px-4 py-2 bg-green-500/10 border border-green-500/30 text-green-400 rounded-lg text-sm font-medium hover:bg-green-500/20 transition">General</a>
        <a href="#gameplay" class="px-4 py-2 bg-blue-500/10 border border-blue-500/30 text-blue-400 rounded-lg text-sm font-medium hover:bg-blue-500/20 transition">Gameplay</a>
        <a href="#communication" class="px-4 py-2 bg-purple-500/10 border border-purple-500/30 text-purple-400 rounded-lg text-sm font-medium hover:bg-purple-500/20 transition">Communication</a>
        <a href="#punishments" class="px-4 py-2 bg-red-500/10 border border-red-500/30 text-red-400 rounded-lg text-sm font-medium hover:bg-red-500/20 transition">Punishments</a>
    </div>
    {{-- Rules Sections --}}
    <div class="space-y-8 pt-8">
        {{-- General Rules --}}
        <div id="general" class="bg-gray-800/50 border border-gray-700 rounded-xl p-6 scroll-mt-24">
        ...
        {{-- Gameplay Rules --}}
        <div id="gameplay" class="bg-gray-800/50 border border-gray-700 rounded-xl p-6 scroll-mt-24">
            <div class="flex items-center gap-3 mb-4">
        ...
        {{-- Communication Rules --}}
        <div id="communication" class="bg-gray-800/50 border border-gray-700 rounded-xl p-6 scroll-mt-24">
            <div class="flex items-center gap-3 mb-4">
        ...
        {{-- Punishments --}}
        <div id="punishments" class="bg-gray-800/50 border border-red-500/30 rounded-xl p-6 scroll-mt-24">
            <div class="flex items-center gap-3 mb-4">
        ...
        <div class="bg-gray-800/50 border border-gray-700 rounded-xl p-6 text-center">
            <h3 class="text-lg font-bold text-white mb-2">Need to Appeal a Ban?</h3>
            <p class="text-gray-400 mb-4">If you believe you were banned unfairly, you can submit an appeal through our Discord server.</p>
            <a href="https://discord.gg/TqSGCNyp" target="_blank" rel="noopener" class="inline-flex items-center gap-2 px-6 py-3 bg-indigo-600 hover:bg-indigo-500 text-white font-medium rounded-lg transition">
