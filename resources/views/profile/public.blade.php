...
<div class="space-y-6">
    ...
    <div class="relative bg-gradient-to-r from-green-600/20 via-gray-800 to-green-600/20 rounded-2xl border border-gray-700/50 overflow-hidden">
        ...
        <div class="relative p-6 sm:p-8">
            <div class="flex flex-col sm:flex-row items-center sm:items-start gap-6">
                ...
                <div class="absolute top-4 right-4 sm:relative sm:top-auto sm:right-auto flex items-center gap-2 flex-shrink-0">
                @if(!$isOwner)
    ...
    <div class="grid lg:grid-cols-3 gap-6">
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-gray-800/50 border border-gray-700 rounded-xl p-10">
                <div class="text-center">
                    ...
                    <p class="text-gray-400">This player hasn't linked their Arma ID or played on our servers yet.</p>
                </div>
            </div>
            @endif
        ...
        <div class="lg:col-span-1 space-y-6">
            ...
            @if($team)
                <div class="bg-gray-800/50 border border-gray-700 rounded-xl p-6">
                    <h3 class="text-lg font-semibold text-white mb-4">Platoon</h3>
