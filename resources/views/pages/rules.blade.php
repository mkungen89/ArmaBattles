...
@section('content')
    ...
    <div class="space-y-8 pt-8">
        ...
        <div class="glass-card rounded-xl p-6 text-center">
            ...
            <a href="{{ site_setting('discord_webhook_url', 'https://discord.gg/TqSGCNyp') }}" target="_blank" rel="noopener" class="inline-flex items-center gap-2 px-6 py-3 bg-indigo-600 hover:bg-indigo-500 text-white font-medium rounded-xl transition">
