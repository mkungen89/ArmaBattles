...
<div class="space-y-20">
    ...
    <div class="relative -mt-6 -mx-4 sm:-mx-6 lg:-mx-8 px-4 sm:px-6 lg:px-8 py-24 md:py-32 overflow-hidden">
        ...
        <div class="relative z-10 text-center">
            ...
            <div class="mt-8 flex flex-wrap items-center justify-center gap-4">
                ...
                <a href="{{ route('auth.google') }}" class="inline-flex items-center space-x-3 px-8 py-4 bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-500 hover:to-blue-400 rounded-xl text-lg font-semibold transition-all duration-300 shadow-lg shadow-blue-500/25 hover:shadow-blue-500/40 hover:scale-105">
    ...
    <div>
        <div class="bg-gradient-to-r from-green-500/10 via-white/3 to-green-500/10 border border-white/5 rounded-2xl p-10 text-center">
            ...
            <p class="text-gray-400 mb-8 max-w-xl mx-auto">Connect with Steam or Google and become part of our community today. See you on the battlefield!</p>
            @guest
