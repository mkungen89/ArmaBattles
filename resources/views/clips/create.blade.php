        ...
        <div class="bg-gray-800/50 border border-gray-700 rounded-xl p-6">
            <form action="{{ route('clips.store') }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="title" required placeholder="Epic 1v5 Clutch" value="{{ old('title') }}" class="w-full bg-gray-900/50 border border-gray-700 text-white rounded-lg px-4 py-2">
                ...
                <div>
                    ...
                    <input type="url" name="url" required placeholder="https://youtube.com/watch?v=..." value="{{ old('url') }}" class="w-full bg-gray-900/50 border border-gray-700 text-white rounded-lg px-4 py-2">
                ...
                <div>
                    ...
                    <textarea name="description" rows="4" placeholder="Describe what happens in the clip..." class="w-full bg-gray-900/50 border border-gray-700 text-white rounded-lg px-4 py-2">{{ old('description') }}</textarea>
                ...
                <div class="flex gap-3">
                    <button type="submit" class="flex-1 px-6 py-3 bg-red-600 hover:bg-red-500 text-white font-semibold rounded-lg transition">
                        Submit Clip
                    </button>
                    <a href="{{ route('clips.index') }}" class="px-6 py-3 bg-gray-700 hover:bg-gray-600 text-white font-semibold rounded-lg transition">
                        Cancel
                    </a>
                </div>
            </form>
