...
<div class="max-w-md mx-auto mt-8">
    <div class="glass-card rounded-xl p-8">
        ...
        <div class="space-y-3">
            ...
            <a href="{{ route('auth.twitch') }}" class="flex items-center justify-center space-x-2 w-full py-2.5 bg-purple-600/20 hover:bg-purple-600/30 border border-purple-500/30 rounded-xl transition">
                <svg class="w-5 h-5 text-purple-400" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M11.571 4.714h1.715v5.143H11.57zm4.715 0H18v5.143h-1.714zM6 0L1.714 4.286v15.428h5.143V24l4.286-4.286h3.428L22.286 12V0zm14.571 11.143l-3.428 3.428h-3.429l-3 3v-3H6.857V1.714h13.714Z"/>
                </svg>
                <span class="text-purple-300">Login with Twitch</span>
            </a>
        </div>

        <p class="mt-6 text-center text-sm text-gray-400">
            Don't have an account? <a href="{{ route('register') }}" class="text-green-400 hover:text-green-300">Register</a>
        </p>
    </div>
</div>
@endsection
