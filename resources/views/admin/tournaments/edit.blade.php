...
<form action="{{ route('admin.tournaments.update', $tournament) }}" method="POST" class="space-y-6">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="4"
                        class="w-full bg-gray-700 border border-gray-600 text-white rounded-lg px-4 py-2 focus:ring-green-500 focus:border-green-500">{{ old('description', $tournament->description) }}</textarea>
                </div>

                <div>
                    <label for="rules" class="block text-sm font-medium text-gray-400 mb-2">Rules</label>
                    <textarea name="rules" id="rules" rows="4"
                        class="w-full bg-gray-700 border border-gray-600 text-white rounded-lg px-4 py-2 focus:ring-green-500 focus:border-green-500">{{ old('rules', $tournament->rules) }}</textarea>
                </div>
    ...
    <div class="flex gap-4">
        ...
        <a href="{{ route('admin.tournaments.show', $tournament) }}" class="px-6 py-2 bg-gray-700 hover:bg-gray-600 text-white rounded-lg transition">
            Cancel
        </a>
    </div>
</form>
