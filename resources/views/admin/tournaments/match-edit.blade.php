...
<div class="max-w-2xl">
    ...
    <form action="{{ route('admin.matches.update', $match) }}" method="POST" class="space-y-6">
        ...
        <div class="glass-card rounded-xl p-6">
            <h2 class="text-sm font-semibold text-white uppercase tracking-wider mb-3">Match settings</h2>
        ...
        <div class="glass-card rounded-xl p-6">
            <h2 class="text-sm font-semibold text-white uppercase tracking-wider mb-3">Result</h2>
        ...
        <div class="glass-card rounded-xl p-6">
            <h2 class="text-sm font-semibold text-white uppercase tracking-wider mb-3">Admin notes</h2>
        ...
        <div class="flex gap-4">
            ...
            <a href="{{ route('admin.tournaments.matches', $match->tournament) }}" class="px-6 py-2 bg-white/5 hover:bg-white/10 text-white rounded-xl transition">
                Cancel
            </a>
        </div>
    </form>
