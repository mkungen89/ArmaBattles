...
<div class="flex items-center justify-between mb-6">
    ...
    <a href="{{ route('admin.tournaments.create') }}" class="px-4 py-2 bg-green-600 hover:bg-green-500 text-white rounded-lg transition font-medium">
        Create Tournament
    </a>
</div>
            ...
            <div class="bg-gray-800/50 border border-gray-700 rounded-xl p-4">
                <div class="flex items-start justify-between gap-4">
                    ...
                    <div class="flex gap-2">
                        <a href="{{ route('admin.tournaments.show', $tournament) }}" class="px-3 py-1.5 bg-gray-700 hover:bg-gray-600 text-white rounded-lg transition text-sm">
                            Manage
                        </a>
                        <a href="{{ route('tournaments.show', $tournament) }}" class="px-3 py-1.5 bg-gray-700 hover:bg-gray-600 text-white rounded-lg transition text-sm" target="_blank">
                            View
                        </a>
                    </div>
                </div>
...
@else
    <div class="bg-gray-800/50 border border-gray-700 rounded-xl p-12 text-center">
        ...
        <a href="{{ route('admin.tournaments.create') }}" class="inline-block px-4 py-2 bg-green-600 hover:bg-green-500 text-white rounded-lg transition">
            Create Tournament
        </a>
    </div>
@endif
