...
<div class="space-y-6">
                    ...
                    <tr class="hover:bg-gray-700/30 transition">
                        ...
                        <td class="px-4 py-3">
                            @if(!empty($result->alt_names))
                                ...
                                <span class="inline-block px-2 py-0.5 bg-gray-700/50 text-gray-300 text-xs rounded-full mr-1 mb-1">{{ $altName }}</span>
                                @endforeach
                            @else
    ...
    {{-- Ban by GUID --}}
    <div class="bg-gray-800/50 border border-gray-700 rounded-xl p-6">
        <h2 class="text-lg font-semibold text-white mb-4">Ban by GUID</h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                <div>
                    ...
                    <input type="text" name="guid" id="guid" required placeholder="Enter player GUID..."
                           class="w-full px-3 py-2 bg-gray-900/50 border border-gray-700 rounded-lg text-sm text-white placeholder-gray-600 focus:outline-none focus:border-green-500/50 font-mono">
                </div>
                <div>
