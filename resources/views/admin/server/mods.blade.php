...
<div class="space-y-6">
    ...
    <div class="grid lg:grid-cols-3 gap-6">
        <div class="lg:col-span-2 space-y-6">
            ...
            {{-- Addon Directories --}}
            <div x-data="{ open: false }" class="bg-gray-800/50 border border-gray-700 rounded-xl p-6">
                ...
                <div x-show="open" x-collapse class="mt-4">
                    <div class="bg-gray-900/50 rounded-lg p-3 space-y-1 font-mono text-xs text-gray-400 max-h-64 overflow-y-auto">
                        ...
                        <div class="px-2 py-1 hover:bg-gray-700/20 rounded">{{ $dir }}</div>
                        @endforeach
        ...
        {{-- Add Mod Form --}}
        <div>
            <div class="bg-gray-800/50 border border-gray-700 rounded-xl p-6 sticky top-24">
                <h2 class="text-lg font-semibold text-white mb-4">Add Mod</h2>
