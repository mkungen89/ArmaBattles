...
<div x-data="configEditor()" class="space-y-6">
    ...
    {{-- Config Tabs --}}
    <div class="flex items-center gap-1 glass-card rounded-xl p-1.5">
        <button @click="activeTab = 'arma'" :class="activeTab === 'arma' ? 'bg-green-500/20 text-green-400 border-green-500/30' : 'text-gray-400 hover:bg-white/5 hover:text-white border-transparent'"
                class="flex-1 text-center px-4 py-2 rounded-lg text-sm font-medium transition border">
            Arma Server Config
        </button>
        <button @click="activeTab = 'stats'" :class="activeTab === 'stats' ? 'bg-green-500/20 text-green-400 border-green-500/30' : 'text-gray-400 hover:bg-white/5 hover:text-white border-transparent'"
                class="flex-1 text-center px-4 py-2 rounded-lg text-sm font-medium transition border">
        ...
        <form method="POST" action="{{ route('admin.server.config.arma.update') }}" x-ref="armaForm"
            ...
            <div class="grid lg:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text" x-model="armaConfig.game.name"
                                       class="w-full px-3 py-2 bg-gray-900/50 border border-white/5 rounded-lg text-sm text-white focus:outline-none focus:border-green-500/50">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" x-model="armaConfig.game.scenarioId"
                                       class="w-full px-3 py-2 bg-gray-900/50 border border-white/5 rounded-lg text-sm text-white font-mono text-xs focus:outline-none focus:border-green-500/50">
                            </div>
                        </div>
                    </div>
                ...
                <div class="space-y-6">
                    ...
                    <div x-data="{ showAdvanced: false }" class="glass-card rounded-xl p-6">
                        ...
                        <div x-show="showAdvanced" x-collapse class="mt-4">
                            ...
                            <textarea x-model="armaJsonRaw" rows="20"
                                      class="w-full px-3 py-2 bg-gray-900/50 border border-white/5 rounded-lg text-xs text-gray-300 font-mono focus:outline-none focus:border-green-500/50 resize-y"></textarea>
                            <button type="button" @click="parseJsonToForm()" class="mt-2 px-3 py-1.5 bg-white/5 hover:bg-white/10 text-gray-300 rounded-lg text-xs transition">
                                Apply JSON to Form
                            </button>
                        </div>
                    </div>
