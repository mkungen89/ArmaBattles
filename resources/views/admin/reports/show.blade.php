...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div class="flex items-center gap-4">
            <a href="{{ route('admin.reports.index') }}" class="p-2 bg-white/5 hover:bg-white/10 text-gray-400 hover:text-white rounded-lg transition">
    ...
    <div class="grid lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="glass-card rounded-xl p-6">
                <h2 class="text-sm font-semibold text-white uppercase tracking-wider mb-3">Report Details</h2>
            ...
            {{-- Admin Action Form --}}
            <div class="glass-card rounded-xl p-6">
                <h2 class="text-sm font-semibold text-white uppercase tracking-wider mb-3">Admin Action</h2>
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <div class="flex flex-wrap gap-2">
                                @foreach(['pending' => ['Pending', 'bg-yellow-600/20 border-yellow-500/30 text-yellow-400'], 'reviewed' => ['Reviewed', 'bg-blue-600/20 border-blue-500/30 text-blue-400'], 'resolved' => ['Resolved', 'bg-green-600/20 border-green-500/30 text-green-400'], 'dismissed' => ['Dismissed', 'bg-gray-500/20 border-gray-500/30 text-gray-400']] as $val => [$label, $classes])
                        ...
                        <div>
                            ...
                            <textarea name="admin_notes" rows="4" maxlength="5000" placeholder="Add notes about actions taken..."
                                      class="w-full px-3 py-2 bg-gray-900/50 border border-white/5 rounded-lg text-sm text-white placeholder-gray-600 focus:outline-none focus:border-green-500/50 resize-y">{{ old('admin_notes', $report->admin_notes) }}</textarea>
                        </div>
                        ...
                        <button type="submit" class="px-6 py-2.5 bg-green-600 hover:bg-green-500 text-white rounded-xl text-sm font-medium transition">
                            Update Report
                        </button>
                    </div>
                </form>
            ...
            <div class="glass-card rounded-xl p-6">
                ...
                <div class="flex flex-wrap gap-3">
                    ...
                    <a href="{{ route('admin.rcon.index') }}" class="px-4 py-2 bg-white/5 hover:bg-white/10 text-white rounded-xl text-sm transition">
        ...
        <div class="space-y-6">
            ...
            <div class="glass-card rounded-xl p-6">
                ...
                <div class="space-y-3 max-h-96 overflow-y-auto">
                    ...
                    <a href="{{ route('admin.reports.show', $prev) }}" class="block p-3 bg-gray-900/30 rounded-lg hover:bg-white/3 transition">
            ...
            {{-- Timeline --}}
            <div class="glass-card rounded-xl p-6">
                <h2 class="text-sm font-semibold text-white uppercase tracking-wider mb-3">Timeline</h2>
                <div class="space-y-4">
