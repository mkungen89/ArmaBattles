...
@section('content')
    <div class="py-12">
            ...
            <div class="bg-gray-800/50 backdrop-blur border border-gray-700 rounded-xl p-6 mb-6">
                <div class="flex items-center gap-4 mb-6">
                    ...
                    @if($reputation->isTrusted())
                        <div class="flex items-center gap-2 px-4 py-2 bg-green-600/20 border border-green-500/30 rounded-lg">
                    ...
                    @elseif($reputation->isFlagged())
                        <div class="flex items-center gap-2 px-4 py-2 bg-red-600/20 border border-red-500/30 rounded-lg">
            ...
            {{-- Commendations --}}
            <div class="bg-gray-800/50 backdrop-blur border border-gray-700 rounded-xl p-6 mb-6">
                <h2 class="text-xl font-bold text-white mb-4">Commendations</h2>
            ...
            @auth
                @if($user->id !== auth()->id())
                    <div class="bg-gray-800/50 backdrop-blur border border-gray-700 rounded-xl p-6 mb-6">
                        <h2 class="text-xl font-bold text-white mb-4">Rate This Player</h2>
                        @if($myVote)
                        ...
                        <form action="{{ route('reputation.vote', $user) }}" method="POST" class="space-y-4">
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    <label class="relative cursor-pointer">
                                        ...
                                        <div class="px-4 py-3 border-2 border-gray-700 peer-checked:border-green-500 peer-checked:bg-green-500/10 rounded-lg text-center transition">
                                    ...
                                    <label class="relative cursor-pointer">
                                        ...
                                        <div class="px-4 py-3 border-2 border-gray-700 peer-checked:border-red-500 peer-checked:bg-red-500/10 rounded-lg text-center transition">
                            ...
                            <div>
                                ...
                                <select name="category" required class="w-full px-4 py-2 bg-gray-900/50 border border-gray-700 rounded-lg text-white focus:border-green-500 focus:ring-2 focus:ring-green-500/20 transition">
                            ...
                            <div>
                                ...
                                <textarea name="comment"
                                          ...
                                          class="w-full px-4 py-2 bg-gray-900/50 border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:border-green-500 focus:ring-2 focus:ring-green-500/20 transition"></textarea>
                                <p class="text-xs text-gray-500 mt-1">Max 500 characters</p>
                            </div>
                            <button type="submit"
                                    class="w-full px-6 py-3 bg-green-600 hover:bg-green-500 text-white font-semibold rounded-lg transition">
            ...
            <div class="bg-gray-800/50 backdrop-blur border border-gray-700 rounded-xl p-6">
                <h2 class="text-xl font-bold text-white mb-4">Recent Votes ({{ $recentVotes->count() }})</h2>
                <div class="space-y-3">
                        ...
                        <div class="bg-gray-900/50 rounded-lg p-4">
                            <div class="flex items-start justify-between mb-2">
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <span class="px-3 py-1 rounded-full text-sm bg-gray-700/50 text-gray-300 capitalize">
                                        {{ $vote->category }}
                                    </span>
                                </div>
                            </div>
