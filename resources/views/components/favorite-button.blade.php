...
<form action="{{ route('favorites.toggle') }}" method="POST" class="inline">
    ...
    <button type="submit" class="flex items-center gap-1 px-3 py-1.5 rounded-lg text-sm transition
        {{ $isFavorited ? 'bg-yellow-500/20 text-yellow-400 border border-yellow-500/30 hover:bg-yellow-500/30' : 'bg-gray-700/50 text-gray-400 border border-gray-600/30 hover:text-yellow-400 hover:border-yellow-500/30' }}"
