...
class Announcement extends Model
{
    ...
    /**
     * Scope to get only active announcements that should be displayed now
     */
    ...
    /**
     * Get the CSS classes for this announcement type
     */
    public function getTypeClassesAttribute(): string
    {
